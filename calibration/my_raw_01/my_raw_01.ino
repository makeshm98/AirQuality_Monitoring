...
void loop()
{
  ...
  if (millis() - getDataTimer >= 2000)
  {
    ...
    if(i == 1)
    {
    Serial.print("Raw CO2: "); Serial.print("\t"); Serial.println("Adjusted CO2: ");
    }
    Serial.print(adjustedCO2); adjustedCO2 = 6.60435861e+15 * exp(-8.78661228e-04 * adjustedCO2);       Serial.print("\t"); Serial.println(adjustedCO2);
    Serial.print("\n");
